...
class TestFitTiltAzimuth(unittest.TestCase):
    ...
    def test_fit_longitude(self):
        ...
        with open(eot_duffie_file_path) as file:
                cos_thetafit = np.genfromtxt(file, delimiter=',')
        # boolean_filter
        filepath = Path(__file__).parent.parent
        ...
        # Expected Longitude Output is generated in tests/fixtures/tilt_azimuth/tilt_azimuth_Estimation_data_creator.ipynb
