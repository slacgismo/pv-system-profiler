...
class TestEquationOfTime(unittest.TestCase):
    ...
    data_file_path = Path(__file__).parent.parent.joinpath("fixtures/longitude_fitting/eot_input.csv")
    ...
    def test_eot_duffie(self):
        ...
        expected_data_file_path = Path(__file__).parent.parent.joinpath("fixtures/longitude_fitting/eot_duffie_output.csv")
    ...
    def test_eot_da_rosa(self):
        ...
        expected_data_file_path = Path(__file__).parent.parent.joinpath("fixtures/longitude_fitting/eot_da_rosa_output.csv")
        with open(expected_data_file_path) as file:
            expected_output = np.genfromtxt(file, delimiter=',')
