class ConfigPartitions:
    def __init__(self, part_id=None, ix_0=None, ix_n=None, n_part=None, ifl=None, ofl=None, skf=None,
                 au=None, ain=None, ar=None, ac=None, script_name=None, scripts_location=None):
        ...
        if ix_0 is not None and ix_n is not None:
            ...
            self.local_working_folder = 'estimation_part_{}_of_{}/'.format(str(part_id + 1), str(n_part))
            self.local_output_file = self.local_working_folder_location + 'data/results_longitude_{}_of_{}.csv'.\
...
def get_config(part_id=None, ix_0=None, ix_n=None, n_part=None, ifl=None, ofl=None, skf=None, au=None, ain=None,
               ar=None, ac=None, script_name=None, scripts_location=None):
    if ix_0 is not None and ix_n is not None:
        return ConfigPartitions(part_id=part_id, ix_0=ix_0, ix_n=ix_n, n_part=n_part, ifl=ifl,  ofl=ofl, skf=skf,
                                au=au, ain=ain, ar=ar, ac=ac, script_name=script_name, scripts_location=scripts_location)
    else:
