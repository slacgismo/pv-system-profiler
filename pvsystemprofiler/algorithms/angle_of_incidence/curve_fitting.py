...
def run_curve_fit(func, keys,  delta, omega, costheta, input_data, init_values, fit_bounds):
    """
    ...
    :param input_data: boolean array specifying days to be used in fitting.
    ...
    """
    costheta_fit = costheta[input_data]
